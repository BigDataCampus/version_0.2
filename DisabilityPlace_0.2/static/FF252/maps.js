...
(function ($) {
    ...
    function mainMap() {
        ...
        function lolo(loData, facarray) {
            ...
            console.log(jl[0].category);
            var html = ('' +
                '<a href="listings-single/' + jl[0].place_ID + '" class="listing-img-container">' +
                '<div class="infoBox-close"><i class="fa fa-times"></i></div>' +
                '<img src="' + '/static/place/'+jl[0].category+'.png' + '" alt="'+jl[0].category+'">' +
                '<div class="listing-item-content">\n' +
                '    <div class="matrix">\n'
            );
            console.log("facarray : "+facarray);
            for(var i = 0; i < facarray.length; i++) {
                html += '   <img title="'+facarray[i]+'" src="/static/facility/'+ facarray[i] +'.png">\n';
            }
            html += ('</div>\n' +
                '<h2>' + jl[0].place_name + '</h2>\n' +
        ...
        for (i = 0; i < wishgohome.length; i++) {
            locations2.push([locationData('listings-single/' + wishgohome[i].place_ID, '/static/place/은행.png', wishgohome[i].place_name, wishgohome[i].place_address, '4.0', '10'), wishgohome[i].lat, wishgohome[i].lng, i, '<i class="im im-icon-Chef-Hat"></i>', wishgohome[i].place_ID]);
        }
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
            ...
            isfind: false,
            center: new google.maps.LatLng(37.5846297, 126.995),
                ...
                for (var i = 0; i < 5; i++) {
                    (function (i) {
                        ...
                        itemlist.innerHTML = "<div class=\"listing-item\">\n" +
                            ...
                            "                                    <img src=\"/static/place/"+data[i].category+".png\">\n" +
